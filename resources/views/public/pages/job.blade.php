...
@section('pageTitle', 'Emploi Mahajanga - Offre d\'emploi')
                                        ...
                                        <div class="job-single-head3">
                                            ...
                                            <div class="job-single-info3">
                                                ...
                                                <ul class="tags-jobs">
                                                    ...
                                                    <li><i class="la la-calendar-o"></i> Date de publication: 29 juillet 2017</li>
                                                    <li><i class="la la-eye"></i> Visites 5683</li>
                                                </ul>
                                            </div>
                                        </div><!-- Job Head -->
                                    </div>
